defmodule Tax do
    ...
    Don’t worry about Enum.each/2 now; you’ll see it in detail in Chapter 5, ​ 
    Using Higher-Order Functions ​ . 
    You only need to know that Enum.each/2 will execute apply_tax in each item of a list.
